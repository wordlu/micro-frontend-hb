...
export default {
    ...
    props: {
        ...
        response: {
            type: Object,
            default: function() {
                return {"data": [{"type": "notifications", "id": "ETL_Iterator_ETL_Iterator_developer_2021-12-10T06_30_01+00_00", "attributes": {"project-id": "ETL_Iterator_ETL_Iterator_developer_compute_111out_0Jj6bBGAh6vIqs5", "owner": "", "show-name": "\u5f20\u7490", "time": -1, "code": "0", "job-desc": "max", "job-cat": "failed", "comments": "<empty>", "message": "{\"type\": \"notification\", \"opname\": \"\u5f20\u7490\", \"cnotification\": {\"jobShowName\": \"ETL_Iterator_ETL_Iterator_developer_compute_111out_0Jj6bBGAh6vIqs5\", \"runId\": \"ETL_Iterator_ETL_Iterator_developer_2021-12-10T06_30_01+00_00\", \"error\": \"\"}}", "date": 1639117863191}}], "meta": {"start_key": "{}"}}
            }
        }
    },
    computed: {},
    async mounted() {
        ...
        let body = {
            ...
            "conditions": {
                "runId": ["=", this.runId],
                "jobId": ["begins_with", this.projectName]
            },
            "limit": 1000,
            "start_key": {}
        }
