<template>
<div class="json-area">
     <JsonViewer :value="JsonData" copyable :expand-depth=5 :expanded="true"></JsonViewer>
</div>
</template>
...
export default {
    ...
    data() {
        return {
            closeIcon: "https://s3.cn-northwest-1.amazonaws.com.cn/general.hubadata.com/icon_close.svg"
        }
    },
    props: {
        JsonData: {
...
.jv-item.jv-string .jv-link {
    color: #0366d6
}

.jv-code .jv-toggle:before {
    padding: 0 2px;
    border-radius: 2px
}
