<template>
<div class="content-active-panel" @click="toArticlePage">
    <div class="active-img">
        <img class="active-img-bgc" :src="bgImgs" alt="">
    </div>
    <div class="active-info">
        <div class="home-avtive-names">
            <span class="active-title">{{title}}</span>
        </div>
        <span class="position-info">{{transDate()}}</span>
    </div>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        toArticlePage() {
            this.$emit('toArticlePage', this.uri)
        }
    },
    props: {
        id: String,
